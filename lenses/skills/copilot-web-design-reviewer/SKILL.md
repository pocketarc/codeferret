...
description: "CodeFerret review lens copilot-web-design-reviewer. A CodeFerret lens agent loads this during a multi-lens code review; it is not a general-purpose skill and is no use outside one."
---
