...
description: CodeFerret's anthropic-code-review lens. Dispatched by /codeferret:review; not for general use.
...
Load the `codeferret:anthropic-code-review` skill and review the diff under it.
