---
name: writing-review
description: CodeFerret's writing-review lens. Dispatched by /codeferret:review; not for general use.
...
Load the `codeferret:writing-review` skill and review the diff under it.
