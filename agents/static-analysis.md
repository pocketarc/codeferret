...
description: CodeFerret's static-analysis lens. Dispatched by /codeferret:review; not for general use.
...
Load the `codeferret:static-analysis` skill and review the diff under it.
